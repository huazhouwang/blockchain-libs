...
test('estimateVsize', () => {
  ...
  expect(estimateVsize(['P2WPKH'], ['P2WPKH', 'P2PKH', 'P2SH-P2WPKH'])).toBe(
    176,
  );
  expect(estimateVsize(['P2PKH'], ['P2WPKH', 'P2PKH', 'P2SH-P2WPKH'])).toBe(
    255,
  );
  expect(
    estimateVsize(['P2SH-P2WPKH'], ['P2WPKH', 'P2PKH', 'P2SH-P2WPKH']),
  ).toBe(199);
